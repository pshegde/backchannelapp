...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { email: @user_profile.email, name: @user_profile.name, password: @user_profile.password, username: @user_profile.username }
    end
  ...
  test "should update user_profile" do
    put :update, id: @user_profile, user_profile: { email: @user_profile.email, name: @user_profile.name, password: @user_profile.password, username: @user_profile.username }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
